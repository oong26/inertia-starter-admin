...
import GridShape from "@/Components/GridShape.vue";
...
<template>
    <div class="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
        ...
        <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
            <h1 class="mb-8 font-bold text-gray-800 text-title-md dark:text-white/90 xl:text-title-2xl"> Coming Soon </h1>
            <p class="mt-10 mb-6 text-base text-gray-700 dark:text-gray-400 sm:text-lg"> Our website is currently under construction, enter your email id to get latest updates and notifications about the website. </p>
            <p class="mb-5 text-sm text-gray-700 dark:text-gray-400">Don't want to miss update? Subscribe now</p>
            <form>
                <div class="flex flex-col gap-2 sm:flex-row sm:gap-3">
                    <div class="w-full sm:w-[320px]">
                        <TextInput type="email" placeholder="Email address" />
                    </div>
                    <button type="submit" class="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm font-medium text-white bg-gray-800 rounded-lg hover:bg-gray-600 dark:bg-brand-500 dark:hover:bg-brand-600 sm:w-auto">
                        <bell-icon class="w-4" /> Notify Me </button>
                </div>
            </form>
        </div>
        <div class="absolute -translate-x-1/2 bottom-6 left-1/2">
            <p class="mt-20 mb-6 text-base text-center text-gray-500 dark:text-gray-400"> Follow Us On </p>
